"""
vds_movies.py
    This Python script controls the display of a web site of favorite movies based
    on the specifications for Udacity Full Stack Web Developer Nanodegree Project 1,
...
#   template has been customized to include movie release date and primary actors
princess_bride = media.Movie("Princess Bride",
                        "A love story",
                        "1987 (USA)",
                        "Cary Elwes, Robin Wright, Mandy Patinkin",
                    "http://t3.gstatic.com/images?q=tbn:ANd9GcTbq9_n-cBBM8GKulH_Ld9GghuXTxs6DIXBCD1NlWfVVlwUflH8",
...
for_a_few_dollars_more = media.Movie(   "For a Few Dollars More",
                                        "A story about the old West",
                                        "1965 (USA)",
                                        "Clint Eastwood, Lee Van Cleef",
                                        "https://upload.wikimedia.org/wikipedia/en/a/ad/Forafewdollarsmore.jpg",
...
movies = [princess_bride, rocky, star_wars, for_a_few_dollars_more, planet_of_the_apes, platoon]
